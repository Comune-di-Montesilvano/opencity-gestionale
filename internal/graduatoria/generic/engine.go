...
func (e *Engine) CSVRecord(categoria string, r graduatoria.RigaGraduatoria, baseURL string) []string {
	...
	return []string{
		...
		graduatoria.FormatValutaIT(ist.ISEE),
		ist.ISEEValidoFino,
		graduatoria.FormatValutaIT(ist.Corrispettivo),
		graduatoria.FormatValutaIT(ist.BeneficioRicevuto),
		graduatoria.FormatValutaIT(r.ImportoRimborso),
		ist.TipoRichiesta,
