...
func (r *Record) ToIstanza() *Istanza {
	ist := &Istanza{
		...
		RichiedenteEmail:    r.StringMap["richiedente_email"],
		RichiedenteTel:      r.StringMap["richiedente_tel"],
		Indirizzo:           r.StringMap["indirizzo"],
		Civico:              r.StringMap["civico"],
		Comune:              r.StringMap["comune"],
		CAP:                 r.StringMap["cap"],
		Provincia:           r.StringMap["provincia"],
		ISEEValidoFino:      r.StringMap["isee_valido_fino"],
		ISEEDSUProtocollo:   r.StringMap["isee_dsu_protocollo"],
